...
function readers_wall($limit = "100")
{
	...
	foreach ($counts as $count ) {
		...
		if ($i < 5) {
			$type .= "<a class=\"item-top item-" . $i . "\" target=\"_blank\" href=\"" . $c_url . "\" title=\"【" . $tt . "】评论：" . $count->cnt . "\"><span class=\"xiaoshi\"><h4>【" . $tt . "】</h4>".$avatar."</span><strong>" . $count->comment_author . "</strong><span class=\"xiaoshi\">" . $c_url . "</span></a>";
		}
		else {
