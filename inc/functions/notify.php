    ...
    */
    ...
    $message = '<div style="background-color:#f8f8f8; border:1px solid #D2D1CB; color:#111; -moz-border-radius:8px; -webkit-border-radius:8px; -khtml-border-radius:8px; border-radius:8px; font-size:14px; width:702px; margin:0 auto; margin-top:10px;">
		<div style="background:#0e79cc; width:100%; height:60px; color:white; -moz-border-radius:6px 6px 0 0; -webkit-border-radius:6px 6px 0 0; -khtml-border-radius:6px 6px 0 0; border-radius:6px 6px 0 0; ">
			<span style="height:60px; line-height:60px; margin-left:30px; font-size:20px;"> 您在<a href="' . get_option('home') . '" style="text-decoration:none; color:#fff;font-weight:600;" target="_blank">' . get_option('blogname') . '</a>上的评论有新回复啦！</span>
		</div>
		<div style="width:90%; margin:0 auto">
			...
			<p>2.找高考资源，就上<a href="http://gaokaobashi.com" style="color:#0e79cc" target="_blank">高考巴士</a>，请认准网址：<a href="http://gaokaobashi.com" style="color:#0e79cc" target="_blank">http://gaokaobashi.com</a>!</p>
			<p>3.<a href="http://gaokaobashi.com" style="color:#0e79cc" target="_blank">高考巴士</a>一个专注高考并不乏乐趣的有良心的高中生网站!</p><br />
		</div>
		<div style="background:#0e79cc; width:100%; height:30px; color:white; -moz-border-radius:0 0 6px 6px; -webkit-border-radius:0 0 6px 6px;; -khtml-border-radius:0 0 6px 6px; border-radius:0 0 6px 6px; ">
			<span style="height:30px; line-height:30px; margin-left:30px; font-size:14px;">以后有空请多来访，<a href="' . get_option('home') . '" style="text-decoration:none; color:#fff;font-weight:600;" target="_blank">' . get_option('blogname') . '</a>在此谢谢您的支持！</span>
		</div>
	</div>';
